                    ...
                    <div class="row"> 
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" name="start_date" value="{{ old('start_date') }}" class="form-control" id="formrow-password-input">
                                @error('start_date')
                                    <span class="badge badge-soft-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row"> 
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea name="about" class="form-control" id="formrow-email-input">{{ old('about') }}</textarea>
                                @error('about')
                                    <span class="badge badge-soft-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row"> 
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea name="qualification" class="form-control" id="formrow-email-input">{{ old('qualification') }}</textarea>
                                @error('qualification')
                                    <span class="badge badge-soft-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row"> 
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea name="education" class="form-control" id="formrow-email-input">{{ old('education') }}</textarea>
                                @error('education')
                                    <span class="badge badge-soft-danger">{{ $message }}</span>
                                @enderror
                            </div>
