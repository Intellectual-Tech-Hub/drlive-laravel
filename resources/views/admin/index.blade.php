                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="pt-4">
                                    ...
                                    <div class="mt-4">
                                        <a href="index.html" class="btn btn-primary waves-effect waves-light btn-sm">View Profile <i class="mdi mdi-arrow-right ms-1"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mt-4">
                                    <a href="index.html" class="btn btn-primary waves-effect waves-light btn-sm">View More <i class="mdi mdi-arrow-right ms-1"></i></a>
                                </div>
                            </div>
                            <div class="col-sm-6">
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center mt-4"><a href="index.html" class="btn btn-primary waves-effect waves-light btn-sm">View More <i class="mdi mdi-arrow-right ms-1"></i></a></div>
                    </div>
                </div>
            </div>
