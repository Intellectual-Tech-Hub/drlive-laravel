                    ...
                    <div class="row"> 
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="time" name="start_time" value="{{ old('start_time') }}" class="form-control" id="formrow-email-input">
                                @error('start_time')
                                    <span class="badge badge-soft-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="time" name="end_time" value="{{ old('end_time') }}" class="form-control" id="formrow-email-input">
                                @error('end_time')
                                    <span class="badge badge-soft-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row"> 
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="sit_quantity" value="{{ old('sit_quantity') }}" class="form-control" id="formrow-email-input">
                                @error('sit_quantity')
                                    <span class="badge badge-soft-danger">{{ $message }}</span>
                                @enderror
                            </div>
