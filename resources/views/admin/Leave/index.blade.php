                ...
                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-bs-toggle="modal" data-bs-target="#myModal{{ $items->id }}"><i class="fas fa-edit"></i></a>
                        
                            
                            <form method="POST" action="{{route('leave.destroy',$items->id)}}">
                            @csrf
                            @method('delete')
                                <button class="btn btn-danger btn-sm warning"  data-id={{$items->id}} style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt"></i></button>
                            </form>
                        </td>
                    </tr>

                     <!-- Modal -->
                     <div id="myModal{{ $items->id }}" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="name" value="{{ $items->Leavetype }}" class="form-control" id="formrow-password-input">
                                                @error('name')
